/**
 * ═══════════════════════════════════════════════════════════════
 * SAVOIRE AI v2.1 — STUDENT STUDY PLATFORM
 * ═══════════════════════════════════════════════════════════════
...
app.post('/api/download/pdf', (req, res) => {
    try {
        ...
        const doc = new PDFDocument({
            ...
            size: 'A4',
            info: {
                Title: `${topic} - Savoire AI Study Notes`,
                Author: 'Savoire AI v2.1',
                Creator: 'Sooban Talha Technologies',
            },
        });

        // Set response headers
        const filename = `${topic.replace(/[^a-zA-Z0-9]/g, '_')}_SavoireAI.pdf`;
        ...
        doc.fontSize(7).fillColor('#4B5563')
           .text('Generated by Savoire AI v2.1', 50, footerY)
...
app.post('/api/download/text', (req, res) => {
    try {
        ...
        const filename = `${topic.replace(/[^a-zA-Z0-9]/g, '_')}_SavoireAI.txt`;
...
╔══════════════════════════════════════════════════════════════╗
║                                                              ║
║   ✦ SAVOIRE AI v2.1 — SERVER STARTED ✦                     ║
║                                                              ║
║   Edition:    Dark Ultra Premium                             ║
║   Port:       ${PORT}                                          ║
